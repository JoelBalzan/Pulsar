...
for i in range(nfile_P970):
	flux = np.max(profiles_P970[i])
	peak_flux_P970.append(flux)
avg_P970 = np.mean(peak_flux_P970)
print("Mean P970 = ", avg_P970, " Jy")
print("Peak E = ", np.max(peak_flux_P970)/avg_P970, "<E>")
...
peak_flux_PX500_38329 = []
for i in range(nfile_PX500_38329):
	flux = np.max(profiles_PX500_38329[i])
	peak_flux_PX500_38329.append(flux)
avg_PX500_38329 = np.mean(peak_flux_PX500_38329)
print("Mean PX500_38329 = ", avg_PX500_38329, " Jy")
print("Peak E = ", np.max(peak_flux_PX500_38329)/avg_PX500_38329, "<E>")
...
peak_flux_PX500_38907 = []
for i in range(nfile_PX500_38907):
	flux = np.max(profiles_PX500_38907[i])
	peak_flux_PX500_38907.append(flux)
avg_PX500_38907 = np.mean(peak_flux_PX500_38907)
print("Mean PX500_38907 = ", avg_PX500_38907, " Jy")
print("Peak E = ", np.max(peak_flux_PX500_38907)/avg_PX500_38907, "<E>")
...
peak_flux_PX500_39167 = []
for i in range(nfile_PX500_39167):
	flux = np.max(profiles_PX500_39167[i])
	peak_flux_PX500_39167.append(flux)
avg_PX500_39167 = np.mean(peak_flux_PX500_39167)
print("Mean PX500_39167 = ", avg_PX500_39167, " Jy")
print("Peak E = ", np.max(peak_flux_PX500_39167)/avg_PX500_39167, "<E>")
...
A4x, A4y = 8.27, 11.69
fontsize=10
fig = plt.figure(figsize=(A4x,6),dpi=300)
g = gridspec.GridSpec(ncols=2, nrows=2, hspace=0.1, wspace=0.12)
#plt.rcParams["font.family"] = "serif"
#plt.rcParams["font.weight"] = "light"

ax_0_0 = fig.add_subplot(g[0, 0])
ax_0_0.hist(peak_flux_P970, bins=int(np.sqrt(len(peak_flux_P970))), edgecolor='black', color='white')
ax_0_0.axvline(avg_P970, color='b', linewidth=2, label = '%s Jy'%np.round(avg_P970, 3))
#ax.set_xscale("log")
#ax.set_yscale("log") 
ax_0_0.set_xlim(0,40)
ax_0_0.set_xticklabels([])
ax_0_0.tick_params(top=True, direction='out')
...
ax_0_1.hist(peak_flux_PX500_38329, bins=int(np.sqrt(len(peak_flux_PX500_38329))), edgecolor='black', color='white')
ax_0_1.axvline(avg_PX500_38329, color='b', linewidth=2, label = '%s Jy'%np.round(avg_PX500_38329, 3))
ax_0_1.set_xlim(0,40)
ax_0_1.set_xticklabels([])
ax_0_1.tick_params(top=True, direction='out')
...
ax_1_0.hist(peak_flux_PX500_38907, bins=int(np.sqrt(len(peak_flux_PX500_38907))), edgecolor='black', color='white')
ax_1_0.axvline(avg_PX500_38907, color='b', linewidth=2, label = '%s Jy'%np.round(avg_PX500_38907, 3))
ax_1_0.set_xlim(0,40)
ax_1_0.tick_params(top=True, direction='out')
ax_1_0.set_xlabel('Peak Flux Density (Jy)', fontsize=fontsize)
...
ax_1_1.hist(peak_flux_PX500_39167, bins=int(np.sqrt(len(peak_flux_PX500_39167))), edgecolor='black', color='white')
ax_1_1.axvline(avg_PX500_39167, color='b', linewidth=2, label = '%s Jy'%np.round(avg_PX500_39167, 3))
ax_1_1.set_xlim(0,40)
ax_1_1.tick_params(top=True, direction='out')
ax_1_1.set_xlabel('Peak Flux Density (Jy)', fontsize=fontsize)
